...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv);">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/schema-modeling.html')">Schema Modeling & Evolution</a></h3>
...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv);">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/schema-manifest.html')">Schema Manifest (beech.schema.ts)</a></h3>
  <p style="color: var(--vp-c-text-2); font-size: 0.9rem;">
...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv);">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/field-policies.html')">Field Policies & Encryption</a></h3>
  <p style="color: var(--vp-c-text-2); font-size: 0.9rem;">
...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv);">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/custom-widgets.html')">Custom Widgets SDK</a></h3>
  <p style="color: var(--vp-c-text-2); font-size: 0.9rem;">
...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv);">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/cli-workflows.html')">CLI Workflows</a></h3>
  <p style="color: var(--vp-c-text-2); font-size: 0.9rem;">
...
<div style="border: 1px solid var(--vp-c-border); border-radius: 8px; padding: 18px; background: var(--vp-c-bg-elv); grid-column: 1 / -1;">
  <h3 style="margin-top: 0;"><a :href="withBase('/build/vertical-slice-architecture.html')">Vertical Slice Architecture</a></h3>
  <p style="color: var(--vp-c-text-2); font-size: 0.9rem;">
