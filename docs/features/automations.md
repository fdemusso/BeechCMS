...
description: Trigger automated workflows, webhooks, and transactional emails on content lifecycle events.
---
...
<p align="center">
  <img src="/images/automations-engine-pipeline.svg" alt="BeechCMS Automations Pipeline: Trigger, Filter & Actions" style="width: 100%; max-width: 860px; margin: 16px 0;" />
</p>
...
> While Resend is configured as the default delivery engine, BeechCMS uses a modular `EmailProvider` architecture. You can easily connect SMTP (such as Mailpit in local development), SendGrid, Postmark, Mailgun, or any custom provider. Learn how in the **[Email Module Guide](/features/email-module)**.
