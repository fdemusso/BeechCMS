...
[BeechCMS](../../../README.md) / [@beechcms/core](../README.md) / HookValidationError
...
> **new HookValidationError**(`message`, `fields?`): `HookValidationError`
...
> `readonly` `optional` **fields?**: `object`[]
