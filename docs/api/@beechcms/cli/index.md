...
[BeechCMS](../../index.md) / @beechcms/cli

# @beechcms/cli

## Interfaces

- [DbMigrateOptions](interfaces/DbMigrateOptions.md)
- [DbResetOptions](interfaces/DbResetOptions.md)
- [DeployOptions](interfaces/DeployOptions.md)
- [DevOptions](interfaces/DevOptions.md)
- [FormsOptions](interfaces/FormsOptions.md)
- [GenerateTypesOptions](interfaces/GenerateTypesOptions.md)
- [InitOptions](interfaces/InitOptions.md)
- [LogsOptions](interfaces/LogsOptions.md)
- [OnboardOptions](interfaces/OnboardOptions.md)
...
- [dbMigrate](functions/dbMigrate.md)
- [dbReset](functions/dbReset.md)
- [deploy](functions/deploy.md)
- [dev](functions/dev.md)
- [devReset](functions/devReset.md)
- [devStop](functions/devStop.md)
- [devTunnel](functions/devTunnel.md)
- [doctor](functions/doctor.md)
- [forms](functions/forms.md)
- [generateTypes](functions/generateTypes.md)
- [init](functions/init.md)
- [lint](functions/lint.md)
- [logs](functions/logs.md)
- [mailpitClear](functions/mailpitClear.md)
- [onboard](functions/onboard.md)
- [reset](functions/reset.md)
- [schemaApply](functions/schemaApply.md)
- [schemaDiff](functions/schemaDiff.md)
- [schemaExport](functions/schemaExport.md)
- [schemaPlan](functions/schemaPlan.md)
- [seedCreate](functions/seedCreate.md)
