...
import { CONDITIONAL_TONE_OPTIONS, getConditionalToneStripClass } from "./shared"
...
interface ConditionalFormatsEditorProps {
  ...
  activeConditionalRule: ConditionalFormatRule | null
  isConditionalEditorOpen: boolean
  setIsConditionalEditorOpen: (open: boolean) => void
  setActiveConditionalRuleId: (ruleId: string | null) => void
  addConditionalFormatRule: (columnId: string) => void
  updateConditionalRule: (ruleId: string, patch: Partial<ConditionalFormatRule>) => void
  updateConditionalTextStyles: (ruleId: string, nextStyles: string[]) => void
  removeConditionalRule: (ruleId: string) => void
  moveConditionalRule: (ruleId: string, dir: -1 | 1) => void
  updateConditionalCondition: (
    ruleId: string,
    conditionId: string,
    patch: Partial<Pick<ToolbarFilterCondition, "op" | "value">>
  ) => void
  addConditionalCondition: (ruleId: string) => void
