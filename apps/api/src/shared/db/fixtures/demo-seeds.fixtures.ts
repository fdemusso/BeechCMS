...
export const DEMO_CLIENTI_SEED: Seed = defineSeed({
  slug: 'clienti',
  label: 'Customer',
...
export const DEMO_ABBONAMENTI_SEED: Seed = defineSeed({
  slug: 'abbonamenti',
  label: 'Subscription',
...
export const DEMO_TICKET_SEED: Seed = defineSeed({
  slug: 'ticket',
...
export const DEMO_CHANGELOG_SEED: Seed = defineSeed({
  slug: 'changelog',
  label: 'Release Note',
...
export const DEMO_ARTICOLI_SEED: Seed = defineSeed({
  slug: 'articoli',
  label: 'Article',
...
export const DEMO_SEEDS: Seed[] = [
  DEMO_CLIENTI_SEED,
  DEMO_ABBONAMENTI_SEED,
  DEMO_TICKET_SEED,
  DEMO_CHANGELOG_SEED,
  DEMO_ARTICOLI_SEED,
]

export const DEMO_SEEDS_BY_SLUG: Record<string, Seed> = {
  clienti: DEMO_CLIENTI_SEED,
  abbonamenti: DEMO_ABBONAMENTI_SEED,
  ticket: DEMO_TICKET_SEED,
  changelog: DEMO_CHANGELOG_SEED,
  articoli: DEMO_ARTICOLI_SEED,
}
